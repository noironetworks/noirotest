...
class neutronPy(object):
    ...
    def get_all_port_details(self, prop=''):
        ...
        try:
            for port in self.get_port_list():
                ...
                if prop and prop not in list(port_details[port['id']].keys()): #If not among above port_properties
    ...
    def get_dhcp_port_details(self):
        ...
        dhcp_ports = {}
        for prop in list(details.values()):
