...
def agent(id):
	...
	json = '{"id":["send_identity",1],"method":"send_identity","params":[{"proto_version":"1.0","name":"example-agent-' + str(id) + '","domain":"comp/prov-OpenStack/ctrlr-[openstack]-openstack/sw-InsiemeLSOid", "my_role":["policy_element"]}]}\0'
	res = s.send(json)
	data = recv_timeout(s)
	print data
	...
	while True:
		...
		json = '{"id":["endpoint_declare",3],"method":"endpoint_declare","params":[{"endpoint":[{"subject":"GbpeVMEp","uri":"/GbpeVMUniverse/GbpeVMEp/1649307c-e335-47a1-b3d1-6b425becd8' + hex_str + '/","properties":[{"name":"uuid","data":"1649307c-e335-47a1-b3d1-6b425becd8' + hex_str + '"}],"children":[],"parent_subject":"GbpeVMUniverse","parent_uri":"/GbpeVMUniverse/","parent_relation":"GbpeVMEp"}],"prr":3600}]}\0'
		res = s.send(json)
		data = recv_timeout(s)
		print data
		...
		json = '{"id":["endpoint_declare",5],"method":"endpoint_declare","params":[{"endpoint":[{"subject":"GbpeTunnelEp","uri":"/GbpeTunnelEpUniverse/GbpeTunnelEp/300a9443-be74-42bc-a789-ee602f4f0e' + hex_str + '/","properties":[{"name":"uuid","data":"300a9443-be74-42bc-a789-ee602f4f0e' + hex_str + '"},{"name":"mac","data":"00:50:56:89:e4:' + hex_str + '"},{"name":"encapId","data":4093},{"name":"terminatorIp","data":"172.28.184.' + str(id) + '"},{"name":"encapType","data":"vlan"}],"children":[],"parent_subject":"GbpeTunnelEpUniverse","parent_uri":"/GbpeTunnelEpUniverse/","parent_relation":"GbpeTunnelEp"}],"prr":3600}]}\0'
		res = s.send(json)
		data = recv_timeout(s)
		print data
		...
		json = '{"id":["endpoint_declare",13],"method":"endpoint_declare","params":[{"endpoint":[{"subject":"EprL3Ep","uri":"/EprL3Universe/EprL3Ep/%2fPolicyUniverse%2fPolicySpace%2fyeah%2fGbpRoutingDomain%2fassNet%2f/192.168.1.' + str(id) + '/","properties":[{"name":"uuid","data":"1649307c-e335-47a1-b3d1-6b425becd8' + hex_str + '"},{"name":"group","data":"/PolicyUniverse/PolicySpace/yeah/GbpEpGroup/noiro%7ccanHazEpg/"},{"name":"ip","data":"192.168.1.' + str(id) + '"},{"name":"context","data":"/PolicyUniverse/PolicySpace/yeah/GbpRoutingDomain/assNet/"},{"name":"mac","data":"36:8c:97:ff:45:' + hex_str + '"}],"children":[],"parent_subject":"EprL3Universe","parent_uri":"/EprL3Universe/","parent_relation":"EprL3Ep"}],"prr":3600}]}\0'
		res = s.send(json)
		data = recv_timeout(s)
		print data
		...
		json = '{"id":["endpoint_declare",14],"method":"endpoint_declare","params":[{"endpoint":[{"subject":"EprL2Ep","uri":"/EprL2Universe/EprL2Ep/%2fPolicyUniverse%2fPolicySpace%2fyeah%2fGbpBridgeDomain%2fassBd%2f/36%3a8c%3a97%3aff%3a45%3a' + hex_str + '/","properties":[{"name":"vmName","data":"kent vm"},{"name":"uuid","data":"1649307c-e335-47a1-b3d1-6b425becd8' + hex_str + '"},{"name":"interfaceName","data":"veth0"},{"name":"group","data":"/PolicyUniverse/PolicySpace/yeah/GbpEpGroup/noiro%7ccanHazEpg/"},{"name":"mac","data":"36:8c:97:ff:45:' + hex_str + '"},{"name":"context","data":"/PolicyUniverse/PolicySpace/yeah/GbpBridgeDomain/assBd/"}],"children":[],"parent_subject":"EprL2Universe","parent_uri":"/EprL2Universe/","parent_relation":"EprL2Ep"}],"prr":3600}]}\0'
		res = s.send(json)
		data = recv_timeout(s)
		print data
		...
		while True:
			...
			json = '{"id":["state_report",' + str(index) + '],"method":"state_report","params":[{"observable":[{"subject":"GbpeEpCounter","uri":"/ObserverEpStatUniverse/GbpeEpCounter/1649307c-e335-47a1-b3d1-6b425becd8' + hex_str + '/","properties":[{"name":"txPackets","data":100869},{"name":"uuid","data":"1649307c-e335-47a1-b3d1-6b425becd8' + hex_str + '"},{"name":"txMulticast","data":0},{"name":"txDrop","data":0},{"name":"txUnicast","data":0},{"name":"txBytes","data":6774533},{"name":"txBroadcast","data":0},{"name":"rxPackets","data":194146},{"name":"rxDrop","data":0},{"name":"rxBytes","data":253096632},{"name":"rxUnicast","data":0},{"name":"rxBroadcast","data":0},{"name":"rxMulticast","data":0}],"children":[],"parent_subject":"ObserverEpStatUniverse","parent_uri":"/ObserverEpStatUniverse/","parent_relation":"GbpeEpCounter"}]}]}\0'
			res = s.send(json)
			data = recv_timeout(s)
			print data
