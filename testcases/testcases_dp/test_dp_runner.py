...
def main():
    ...
    #header_to_suite_map = {'header1': [header1,test_same_ptg_same_l2p_same_l3p], #TODO: Implement this once individual testing is done
    ...
    header_to_suite_map = {'header3': [header3,test_diff_ptg_diff_l2p_same_l3p]}
