...
class  testcase_gbp_aci_intg_leaf_vpc_3(object):
    """
    ...
    def __init__(self,params):
      ...
      self.leaf_port = params['leaf1_port2'] #This connects Leaf1 to Comp-node2
    ...
    def test_step_DisconnectLeafOneHost(self):
        ...
        """
        self._log.info("\nStep to Disconnect Link between Leaf1 and Comp-Node-2\n")
