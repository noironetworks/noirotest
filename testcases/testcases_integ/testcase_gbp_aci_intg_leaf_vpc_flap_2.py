...
class  testcase_gbp_aci_intg_leaf_vpc_2(object):
    ...
    def __init__(self,params):
      ...
      self.leaf_port = params['leaf2_port1'] #This connects Leaf2 to Comp-node1
    ...
    def test_runner(self):
        ...
        self._log.info("\nSteps of the TESTCASE_GBP_INTG_LEAF_VPC_2_VPC_DISCON_LEAF2_NODE1 to be executed\n")
    ...
    def test_step_DisconnectLeafOneHost(self):
        ...
        """
        self._log.info("\n Step to Disconnect Link between Leaf2 and Comp-Node-1\n")
