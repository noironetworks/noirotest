...
class testcase_gbp_aci_intg_leaf_vpc_flap_2(object):
    """
    ...
    hdlr = logging.FileHandler('/tmp/testcase_gbp_aci_intg_leaf_vpc_flap_2.log')
    ...
    def __init__(self,params):
      ...
      self.leaf1_port = params['leaf1_port2'] #This connects Leaf1 to Comp-node2
      self.leaf2_port = params['leaf2_port2'] #This connects Leaf2 to Comp-node2
    ...
    def test_runner(self):
        ...
        """
        test_name = 'VPC_DISCON_LEAF1&2_NODE2'
        self._log.info("\nSteps of the TESTCASE_GBP_INTG_LEAF_VPC_2_VPC_DISCON_LEAF1&2_NODE2 to be executed\n")
    ...
    def test_step_DisconnectLeaf1Host(self):
        """
        Test Step to Disconnect Leaf1 Port of vPC from Comp-node2
        """
        self._log.info("\nStep to Disconnect Link between Leaf1 and Comp-Node-2 in vPC\n")
    ...
    def test_step_DisconnectLeaf2Host(self):
        """
        Test Step to Disconnect Leaf2 Port from Comp-node2
        """
        self._log.info("\nStep to Disconnect Link between Leaf2 and Comp-Node-2 in vPC\n")
        # Before disabling Leaf2-CompNode1 link, ensure to enable Leaf1-CompNode2 link
        self.gbpaci.enable_disable_switch_port(self.apic_ip,self.node1_id,'enable',self.leaf1_port)
        print '\n Sleeping for 30 secs after enabling Leaf1-CompNode2 link'
        sleep(30)
        self._log.info("\nStep to Disconnect Link between Leaf2 and Comp-Node-2 in vPC\n")
