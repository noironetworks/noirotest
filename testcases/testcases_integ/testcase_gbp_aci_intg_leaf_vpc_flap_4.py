...
class  testcase_gbp_aci_intg_leaf_vpc_4(object):
    """
    ...
    def __init__(self,params):
      ...
      self.leaf_port = params['leaf2_port2'] #This connects Leaf2 to Comp-node2
    ...
    def test_runner(self):
        ...
        """
        test_name = 'VPC_DISCON_LEAF2_NODE2'
        self._log.info("\nSteps of the TESTCASE_GBP_INTG_LEAF_VPC_4_VPC_DISCON_LEAF2_NODE2 to be executed\n")
    ...
    def test_step_DisconnectLeafOneHost(self):
        """
        Test Step to Disconnect Leaf Port from One Comp-node2
        """
        self._log.info("\nStep to Disconnect Link between Leaf2 and Comp-Node-2\n")
