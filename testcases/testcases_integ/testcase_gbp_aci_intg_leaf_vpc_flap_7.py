...
class  testcase_gbp_aci_intg_leaf_vpc_7(object):
    """
    ...
    hdlr = logging.FileHandler('/tmp/ testcase_gbp_aci_intg_leaf_vpc_7.log')
    ...
    def test_runner(self):
        ...
        self._log.info("\nSteps of the TESTCASE_GBP_INTG_LEAF_VPC_7_VPC_DISCON_LEAF1_NODE1_LEAF2_NODE2 to be executed\n")
