...
class testcase_gbp_aci_intg_leaf_vpc_flap_6(object):
    """
    ...
    hdlr = logging.FileHandler('/tmp/testcase_gbp_aci_intg_leaf_vpc_flap_6.log')
    ...
    def test_runner(self):
        ...
        """
        test_name = 'VPC_DISCON_LEAF1_NODE2_LEAF2_NODE1'
        self._log.info("\nSteps of the TESTCASE_GBP_INTG_LEAF_VPC_6_VPC_DISCON_LEAF1_NODE2_LEAF2_NODE1 to be executed\n")
    ...
    def test_step_DisconnectLeafsFromHosts(self):
        ...
        if self.gbpaci.enable_disable_switch_port(self.apic_ip,self.leaf1_node_id,'disable',self.leaf1_port_comp_node2) == 0:
           return 0
        if self.gbpaci.enable_disable_switch_port(self.apic_ip,self.leaf2_node_id,'disable',self.leaf2_port_comp_node1) == 0:
           return 0
        return 1
    ...
    def test_CleanUp(self):
        ...
        self.gbpaci.enable_disable_switch_port(self.apic_ip,self.leaf1_node_id,'enable',self.leaf1_port_comp_node2)
        self.gbpaci.enable_disable_switch_port(self.apic_ip,self.leaf2_node_id,'enable',self.leaf2_port_comp_node1)
