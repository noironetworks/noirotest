...
class testcase_gbp_intg_leaf_2(object):
    """
    ...
    hdlr = logging.FileHandler('/tmp/testcase_gbp_intg_leaf_2.log')
    ...
    def test_step_VerifyTrafficIntraHost(self):
        """
        Send and Verify traffic between VMs of Comp-node1 which is 
        """
