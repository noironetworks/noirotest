...
class  testcase_gbp_aci_intg_leaf_vpc_8(object):
    """
    ...
    hdlr = logging.FileHandler('/tmp/testcase_gbp_aci_intg_leaf_vpc_8.log')
    ...
    def test_runner(self):
        ...
        self._log.info("\nSteps of the TESTCASE_GBP_INTG_LEAF_VPC_8_VPC_DISCON_LEAF1_NODE2_LEAF2_NODE1 to be executed\n")
