...
class TestcaseSameptgl2pl3p(object):
    """
    ...
    hdlr = logging.FileHandler('/tmp/testclass_gbp_sameptgl2l3p.log')
    ...
    def test_runner(self):
        ...
        test_traff_with_no_contract()
        test_traff_apply_contract(ptg,prs)
        test_traff_upd_pr_new_pc(rule,classifier)
        test_traff_upd_contract_new_pr(ruleset,rule)
        test_traff_upd_ptg_new_contract(ptg,prs)
